...
<body class="container mt-4">
    ...
    <form action="bode.htm" method="get" class="row g-2 mb-3">
        ...
        <div class="col-auto">
            <select name="trinhDo" class="form-select">
                ...
                <option value="A" ${trinhDo == 'A' ? 'selected' : ''}>A - ĐH Chuyên ngành</option>
                <option value="B" ${trinhDo == 'B' ? 'selected' : ''}>B - ĐH Không chuyên</option>
                <option value="C" ${trinhDo == 'C' ? 'selected' : ''}>C - Cao đẳng</option>
            </select>
        </div>
        <div class="col-auto">
    ...
    <a href="bode-them.htm" class="btn btn-primary mb-3">+ Thêm câu hỏi</a>
        ...
        <tbody>
            <c:forEach var="bd" items="${list}">
                <tr>
                    ...
                    <td>
                        <a href="bode-sua.htm?cauHoi=${bd.cauHoi}" 
                           class="btn btn-sm btn-warning">Sửa</a>
                        <a href="bode-xoa.htm?cauHoi=${bd.cauHoi}"
