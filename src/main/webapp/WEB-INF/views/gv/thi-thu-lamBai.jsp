...
<body>
        ...
        <form id="formThi"
            ...
            <div class="text-center mt-3 mb-5">
                <button type="button" class="btn btn-warning btn-lg"
                    onclick="xacNhanNopBai()">Kết thúc thi thử</button>
            </div>
        </form>
    </div>
    ...
    <div id="floatPanel">
        ...
        <div style="padding: 8px 10px; border-top: 1px solid #dee2e6;">
            <button type="button" onclick="xacNhanNopBai()"
                class="btn btn-warning btn-sm w-100">Kết thúc thi thử</button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title">Xác nhận kết thúc thi thử</h5>
                </div>
                <div class="modal-body">
                    Bạn chắc chắn muốn kết thúc thi thử? Kết quả sẽ không được ghi vào bảng điểm.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        data-bs-dismiss="modal">Tiếp tục làm bài</button>
                    <button type="button" class="btn btn-warning"
                        onclick="thucSuNopBai()">Kết thúc</button>
                </div>
            </div>
        </div>
    </div>
    ...
    function capNhatDongHo() {
        ...
        if (thoiGian <= 0) {
            thucSuNopBai(); // dùng luôn hàm submit, không dùng alert
            return;
        }
