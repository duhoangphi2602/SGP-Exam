...
<body>
    ...
    <div id="overlayLoi">
        <div class="noiDung">
            ...
            <button class="btn btn-light mt-3" onclick="location.reload()">Thử kết nối lại</button>
        </div>
    </div>
                ...
                <div class="cau-hoi" id="cau_${st.index + 1}">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio"
                            ...
                            onchange="danhDau(${st.index + 1}, ${cau.cauHoi})"/>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn chắc chắn muốn nộp bài? Sau khi nộp sẽ không thể làm lại.
                </div>
    ...
    function capNhatDongHo() {
        ...
        if (thoiGian <= 0) {
            thucSuNopBai(); // tự nộp, không dùng alert
            return;
        }
