                ...
                <div class="cau-hoi" id="cau_${st.index + 1}">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" 
                               name="dapAn_${cau.cauHoi}" value="A" 
                               id="A_${cau.cauHoi}"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" 
                               name="dapAn_${cau.cauHoi}" value="B" 
                               id="B_${cau.cauHoi}"
                               onchange="danhDau(${st.index + 1})"/>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" 
                               name="dapAn_${cau.cauHoi}" value="C" 
                               id="C_${cau.cauHoi}"
                               onchange="danhDau(${st.index + 1})"/>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" 
                               name="dapAn_${cau.cauHoi}" value="D" 
                               id="D_${cau.cauHoi}"
                               onchange="danhDau(${st.index + 1})"/>
...
// Đánh dấu câu đã làm
function danhDau(soCau) {
    var btn = document.getElementById('btnCau_' + soCau);
