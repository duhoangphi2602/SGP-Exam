		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<form action="thi-batdau.htm" method="post">
					<div class="row g-3">
						...
						<div class="col-md-4">
							<label class="form-label">Môn học</label> <select name="maMH"
								id="maMH" class="form-select" onchange="loadNgayThi()" required>
						...
						<!-- Chọn ngày thi -->
						<div class="col-md-3">
							<label class="form-label">Ngày thi</label> <select name="ngayThi"
								id="ngayThi" class="form-select" onchange="loadLanThi()"
								required>
						...
						<div class="col-md-2">
							<label class="form-label">Lần thi</label> <select name="lan"
								id="lan" class="form-select" onchange="loadThongTin()" required>
					...
					<div class="mt-3">
						<button type="submit" id="btnBatDau" class="btn btn-success"
							disabled>Bắt đầu thi</button>
					</div>
				</form>
			</div>
		</div>
							...
							<tr>
								...
								<td><c:choose>
										<c:when test="${ca.TRANGTHAI == 'DA_THI'}">
											<span class="badge bg-success"> Đã thi: ${ca.DIEM} </span>
										</c:when>
