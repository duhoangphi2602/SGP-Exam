...
<body class="container mt-4">
    ...
    <a href="giaovien-them.htm" class="btn btn-primary mb-3">+ Thêm giáo viên</a>
        ...
        <tbody>
            <c:forEach var="gv" items="${list}">
                <tr>
                    ...
                    <td>${gv.diaChi}</td>
                    <td>
                        <a href="giaovien-sua.htm?ma=${gv.maGV}" 
                           class="btn btn-sm btn-warning">Sửa</a>
                        <a href="giaovien-xoa.htm?ma=${gv.maGV}"
                           class="btn btn-sm btn-danger"
                           onclick="return confirm('Xóa giáo viên này?')">Xóa</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
