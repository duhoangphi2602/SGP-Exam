			...
			<ul class="navbar-nav">
				<li class="nav-item"><span class="nav-link text-white">
					...
					${sessionScope.maGV} -
						...
						</c:choose> ${sessionScope.hoTen} - ${sessionScope.role}
				</span></li>
				<li class="nav-item"><a class="nav-link"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p id="globalConfirmMessage">Bạn có chắc chắn muốn thực hiện
					thao tác này?</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary"
					data-bs-dismiss="modal">Hủy</button>
				<button type="button" class="btn btn-primary" id="globalConfirmBtn">Đồng
					ý</button>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="globalAlertModal" tabindex="-1"
	aria-labelledby="globalAlertModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
